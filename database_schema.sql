-- =====================================================
-- NoFap App Database Schema for Supabase
-- =====================================================
...
-- Tracks user's NoFap streaks
-- =====================================================
CREATE TABLE public.user_streaks (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID REFERENCES public.user_profiles(id) ON DELETE CASCADE NOT NULL,
  start_date DATE NOT NULL,
  end_date DATE NULL, -- NULL means current active streak
...
-- Tracks daily check-ins and mood
-- =====================================================
...
-- Tracks panic button usage and outcomes
-- =====================================================
...
-- For future journal/reflection features
-- =====================================================
...
CREATE INDEX idx_user_streaks_active ON public.user_streaks(user_id, is_active);
